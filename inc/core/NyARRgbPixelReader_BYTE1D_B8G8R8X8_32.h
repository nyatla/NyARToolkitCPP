...
{
	class NyARRgbPixelReader_BYTE1D_B8G8R8X8_32 :public INyARRgbPixelReader
	{
	protected:
		NyAR_BYTE_t* _ref_buf;
	private:
		const TNyARIntSize* _ref_size;
	public:
		NyARRgbPixelReader_BYTE1D_B8G8R8X8_32(const TNyARIntSize* i_size,NyAR_BYTE_t* i_buf);
