...
{
	NyARRaster_BasicClass::NyARRaster_BasicClass(int i_width,int i_height,int i_buffer_type)
	{
	...
	int NyARRaster_BasicClass::getBufferType()const
	{
		return this->_buffer_type;
	}
	bool NyARRaster_BasicClass::isEqualBufferType(int i_type_value)const
	{
