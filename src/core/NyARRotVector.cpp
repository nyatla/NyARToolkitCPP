...
namespace NyARToolkitCPP
{
	 ...
	 void NyARRotVector::exteriorProductFromLinear(const TNyARLinear& i_linear1, const TNyARLinear& i_linear2)
	{
		...
		const double w1 = i_linear1.dy * i_linear2.dx - i_linear2.dy * i_linear1.dx;
		const double w2 = i_linear1.dx * i_linear2.c - i_linear2.dx * i_linear1.c;
		const double w3 = i_linear1.c * i_linear2.dy - i_linear2.c * i_linear1.dy;
