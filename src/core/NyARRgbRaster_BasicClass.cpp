...
{
	NyARRgbRaster_BasicClass::NyARRgbRaster_BasicClass(int i_width,int i_height,int i_buffer_type)
	{
	...
	int NyARRgbRaster_BasicClass::getBufferType()const
	{
		return _buffer_type;
	}
	bool NyARRgbRaster_BasicClass::isEqualBufferType(int i_type_value)const
	{
