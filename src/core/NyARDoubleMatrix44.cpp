...
{
	NyArray<NyARDoubleMatrix44>* NyARDoubleMatrix44::createArray(int i_number)
	{
		return new NyArray<NyARDoubleMatrix44>(i_number);
	}

	/**
	 * ’x‚¢‚©‚ç‚ ‚ñ‚Ü‚èŽg‚í‚È‚¢‚Å‚ËB
	 */
	void NyARDoubleMatrix44::setValue(const double i_value[])
	{
		this->m00=i_value[ 0];
		this->m01=i_value[ 1];
		this->m02=i_value[ 2];
	 ...
	 * ’x‚¢‚©‚ç‚ ‚ñ‚Ü‚èŽg‚í‚È‚¢‚Å‚ËB
	 */
	void NyARDoubleMatrix44::getValue(double o_value[])const
	{
		o_value[ 0]=this->m00;
		o_value[ 1]=this->m01;
		o_value[ 2]=this->m02;
