================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: NyWin32CaptureTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した NyWin32CaptureTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには NyWin32CaptureTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

NyWin32CaptureTest.vcproj
...
NyWin32CaptureTest.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CNyWin32CaptureTestApp アプリケーション クラスを宣言します。

NyWin32CaptureTest.cpp
   これは、アプリケーション クラス CNyWin32CaptureTestApp を含むメイン アプリケー
   ション ソース ファイルです。

NyWin32CaptureTest.rc
...
res\NyWin32CaptureTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル NyWin32CaptureTest.rc に含まれていま
   す。

res\NyWin32CaptureTest.rc2
...
NyWin32CaptureTestDlg.h, NyWin32CaptureTestDlg.cpp - ダイアログ
   これらのファイルは CNyWin32CaptureTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な NyWin32CaptureTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   NyWin32CaptureTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
